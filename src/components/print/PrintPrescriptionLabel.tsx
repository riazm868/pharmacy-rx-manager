...
const PHARMACY_INFO = {
  ...
  address: '123 Health Street, Anytown, ST 12345',
  phone: '(555) 123-4567'
};
...
const PrintPrescriptionLabel: React.FC<PrintPrescriptionLabelProps> = ({
  ...
  // Check print server status on component mount
  React.useEffect(() => {
  ...
  return (
    <div className="print-prescription-container">
      ...
      <div className="bg-white p-4 rounded-lg shadow-lg max-w-md mx-auto">
        ...
        <div className="mb-4" style={{ width: '3.2in', height: '2.2in', margin: '0 auto', padding: '0.1in', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)' }}>
          <PrescriptionLabel
            prescription={prescription}
            patient={patient}
            doctor={doctor}
